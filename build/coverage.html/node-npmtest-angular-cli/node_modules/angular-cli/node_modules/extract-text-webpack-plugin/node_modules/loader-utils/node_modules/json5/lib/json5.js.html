...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular-cli/node_modules/angular-cli/node_modules/extract-text-webpack-plugin/node_modules/loader-utils/node_modules/json5/lib/json5.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/extract-text-webpack-plugin/node_modules/loader-utils/node_modules/json5/lib/json5.js</span></h1>
    <h2>
        
        Statements: <span class="metric">4.29% <small>(15 / 350)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">0.36% <small>(1 / 274)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">3.33% <small>(1 / 30)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">4.29% <small>(15 / 350)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/extract-text-webpack-plugin/node_modules/loader-utils/node_modules/json5/lib/</a> &#187; json5.js</div>
</div>
<div class="body">
...
&nbsp;
    var at,           // The index of the current character
        ...
        text,
&nbsp;
        renderChar = <span class="fstat-no" title="function not covered" >function (chr) {</span>
<span class="cstat-no" title="statement not covered" >            return chr === '' ? 'EOF' : "'" + chr + "'";</span>
        },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            error.message = m + " at line " + lineNumber + " column " + columnNumber + " of the JSON5 data. Still to read: " + JSON.stringify(text.substring(at - 1, at + 19));</span>
...
<span class="cstat-no" title="statement not covered" >            error.columnNumber = columnNumber;</span>
...
<span class="cstat-no" title="statement not covered" >                error("Expected " + renderChar(c) + " instead of " + renderChar(ch));</span>
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            columnNumber++;</span>
<span class="cstat-no" title="statement not covered" >            if (ch === '\n' || ch === '\r' &amp;&amp; peek() !== '\n') {</span>
<span class="cstat-no" title="statement not covered" >                lineNumber++;</span>
<span class="cstat-no" title="statement not covered" >                columnNumber = 0;</span>
            }
...
<span class="cstat-no" title="statement not covered" >            if ((ch !== '_' &amp;&amp; ch !== '$') &amp;&amp;</span>
                    (ch &lt; 'a' || ch &gt; 'z') &amp;&amp;
                    (ch &lt; 'A' || ch &gt; 'Z')) {
<span class="cstat-no" title="statement not covered" >                error("Bad identifier as unquoted key");</span>
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            error("Unexpected " + renderChar(ch));</span>
        },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        columnNumber = 1;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function isWordChar(c) {</span>
<span class="cstat-no" title="statement not covered" >        return (c &gt;= 'a' &amp;&amp; c &lt;= 'z') ||</span>
            (c &gt;= 'A' &amp;&amp; c &lt;= 'Z') ||
            (c &gt;= '0' &amp;&amp; c &lt;= '9') ||
            c === '_' || c === '$';
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function isWordStart(c) {</span>
<span class="cstat-no" title="statement not covered" >        return (c &gt;= 'a' &amp;&amp; c &lt;= 'z') ||</span>
            (c &gt;= 'A' &amp;&amp; c &lt;= 'Z') ||
            c === '_' || c === '$';
    }
...
<span class="cstat-no" title="statement not covered" >                    if (obj_part.length) {</span>
...
<span class="cstat-no" title="statement not covered" >                                key = isWord(prop) ? prop : escapeString(prop);</span>
