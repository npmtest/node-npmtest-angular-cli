...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/warning.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/warning.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/</a> &#187; warning.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function Warning(text) {</span>
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.type = 'warning';</span>
    /**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (opts.node &amp;&amp; opts.node.source) {</span>
<span class="cstat-no" title="statement not covered" >      var pos = opts.node.positionBy(opts);</span>
      /**
       ...
       * warning.line //=&gt; 5
       */
<span class="cstat-no" title="statement not covered" >      this.line = pos.line;</span>
      /**
       ...
       * warning.column //=&gt; 6
       */
<span class="cstat-no" title="statement not covered" >      this.column = pos.column;</span>
    }
&nbsp;
...
&nbsp;
&nbsp;
  Warning.prototype.toString = <span class="fstat-no" title="function not covered" >function toString() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.node) {</span>
<span class="cstat-no" title="statement not covered" >      return this.node.error(this.text, {</span>
        plugin: this.plugin,
        index: this.index,
        word: this.word
      }).message;
    } else <span class="cstat-no" title="statement not covered" >if (this.plugin) {</span>
<span class="cstat-no" title="statement not covered" >      return this.plugin + ': ' + this.text;</span>
    } else {
