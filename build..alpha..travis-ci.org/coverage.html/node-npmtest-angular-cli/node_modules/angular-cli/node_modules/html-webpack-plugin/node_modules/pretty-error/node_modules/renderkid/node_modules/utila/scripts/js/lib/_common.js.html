...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular-cli/node_modules/angular-cli/node_modules/html-webpack-plugin/node_modules/pretty-error/node_modules/renderkid/node_modules/utila/scripts/js/lib/_common.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/html-webpack-plugin/node_modules/pretty-error/node_modules/renderkid/node_modules/utila/scripts/js/lib/_common.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/html-webpack-plugin/node_modules/pretty-error/node_modules/renderkid/node_modules/utila/scripts/js/lib/</a> &#187; _common.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  isBareObject: function(o) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if ((o != null) &amp;&amp; o.constructor === Object) {
      return true;
    }
...
&nbsp;
  ...
  typeOf: function(item) {
    var _ref;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (item === null) {
<span class="cstat-no" title="statement not covered" >      return 'null';</span>
    }
    if (typeof item !== 'object') {
      return typeof item;
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(item)) {
<span class="cstat-no" title="statement not covered" >      return 'array';</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (item.nodeName) {
...
<span class="cstat-no" title="statement not covered" >        return (_ref = /\S/.test(item.nodeValue)) != null ? _ref : {</span>
    ...
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof item.length === 'number') {
...
&nbsp;
  ...
  _cloneObject: function(o, includePrototype) {
    var clone, key;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (includePrototype == null) {
<span class="cstat-no" title="statement not covered" >      includePrototype = false;</span>
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (common.isBareObject(o)) {
      clone = {};
      for (key in o) {
