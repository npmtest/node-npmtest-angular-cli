...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular-cli/node_modules/angular-cli/node_modules/html-webpack-plugin/node_modules/pretty-error/node_modules/renderkid/node_modules/utila/scripts/js/lib/Emitter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/html-webpack-plugin/node_modules/pretty-error/node_modules/renderkid/node_modules/utila/scripts/js/lib/Emitter.js</span></h1>
    <h2>
        
        Statements: <span class="metric">15.96% <small>(15 / 94)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/html-webpack-plugin/node_modules/pretty-error/node_modules/renderkid/node_modules/utila/scripts/js/lib/</a> &#187; Emitter.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var Emitter, array;
&nbsp;
array = require('./array');
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this._listenersForAnyEvent = [];</span>
<span class="cstat-no" title="statement not covered" >    this._disabledEmitters = {};</span>
  }
&nbsp;
  Emitter.prototype.on = <span class="fstat-no" title="function not covered" >function(eventName, listener) {</span>
<span class="cstat-no" title="statement not covered" >    if (this._listeners[eventName] == null) {</span>
<span class="cstat-no" title="statement not covered" >      this._listeners[eventName] = [];</span>
    }
<span class="cstat-no" title="statement not covered" >    this._listeners[eventName].push(listener);</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  Emitter.prototype.once = <span class="fstat-no" title="function not covered" >function(eventName, listener) {</span>
<span class="cstat-no" title="statement not covered" >    var cb, ran;</span>
<span class="cstat-no" title="statement not covered" >    ran = false;</span>
...
<span class="cstat-no" title="statement not covered" >          return _this.removeEvent(eventName, cb);</span>
        }, 0);
      };
    })(this);
<span class="cstat-no" title="statement not covered" >    this.on(eventName, cb);</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  Emitter.prototype.onAnyEvent = <span class="fstat-no" title="function not covered" >function(listener) {</span>
<span class="cstat-no" title="statement not covered" >    this._listenersForAnyEvent.push(listener);</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  Emitter.prototype.removeEvent = <span class="fstat-no" title="function not covered" >function(eventName, listener) {</span>
<span class="cstat-no" title="statement not covered" >    if (this._listeners[eventName] == null) {</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
<span class="cstat-no" title="statement not covered" >    array.pluckOneItem(this._listeners[eventName], listener);</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  Emitter.prototype.removeListeners = <span class="fstat-no" title="function not covered" >function(eventName) {</span>
<span class="cstat-no" title="statement not covered" >    if (this._listeners[eventName] == null) {</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
<span class="cstat-no" title="statement not covered" >    this._listeners[eventName].length = 0;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  Emitter.prototype.removeAllListeners = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    var listeners, name, _ref;</span>
<span class="cstat-no" title="statement not covered" >    _ref = this._listeners;</span>
<span class="cstat-no" title="statement not covered" >    for (name in _ref) {</span>
<span class="cstat-no" title="statement not covered" >      listeners = _ref[name];</span>
<span class="cstat-no" title="statement not covered" >      listeners.length = 0;</span>
    }
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  Emitter.prototype._emit = <span class="fstat-no" title="function not covered" >function(eventName, data) {</span>
<span class="cstat-no" title="statement not covered" >    var listener, _i, _j, _len, _len1, _ref, _ref1;</span>
<span class="cstat-no" title="statement not covered" >    _ref = this._listenersForAnyEvent;</span>
<span class="cstat-no" title="statement not covered" >    for (_i = 0, _len = _ref.length; _i &lt; _len; _i++) {</span>
<span class="cstat-no" title="statement not covered" >      listener = _ref[_i];</span>
<span class="cstat-no" title="statement not covered" >      listener.call(this, data, eventName);</span>
    }
<span class="cstat-no" title="statement not covered" >    if (this._listeners[eventName] == null) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    _ref1 = this._listeners[eventName];</span>
<span class="cstat-no" title="statement not covered" >    for (_j = 0, _len1 = _ref1.length; _j &lt; _len1; _j++) {</span>
<span class="cstat-no" title="statement not covered" >      listener = _ref1[_j];</span>
<span class="cstat-no" title="statement not covered" >      listener.call(this, data);</span>
    }
  };
&nbsp;
  Emitter.prototype._throttleEmitterMethod = <span class="fstat-no" title="function not covered" >function(fnName, time) {</span>
<span class="cstat-no" title="statement not covered" >    var lastCallArgs, originalFn, pend, pending, runIt, timer;</span>
...
<span class="cstat-no" title="statement not covered" >    originalFn = this[fnName];</span>
<span class="cstat-no" title="statement not covered" >    if (typeof originalFn !== 'function') {</span>
<span class="cstat-no" title="statement not covered" >      throw Error("this class does not have a method called '" + fnName + "'");</span>
    }
<span class="cstat-no" title="statement not covered" >    lastCallArgs = null;</span>
...
<span class="cstat-no" title="statement not covered" >    this[fnName] = (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >      return <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >        lastCallArgs = arguments;</span>
<span class="cstat-no" title="statement not covered" >        return pend();</span>
      };
    })(this);
<span class="cstat-no" title="statement not covered" >    pend = (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >      return <span class="fstat-no" title="function not covered" >function() {</span></span>
...
<span class="cstat-no" title="statement not covered" >        timer = setTimeout(runIt, time);</span>
<span class="cstat-no" title="statement not covered" >        return pending = true;</span>
      };
    })(this);
<span class="cstat-no" title="statement not covered" >    return runIt = (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >      return <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >        pending = false;</span>
<span class="cstat-no" title="statement not covered" >        return originalFn.apply(_this, lastCallArgs);</span>
      };
    })(this);
  };
&nbsp;
  Emitter.prototype._disableEmitter = <span class="fstat-no" title="function not covered" >function(fnName) {</span>
<span class="cstat-no" title="statement not covered" >    if (this._disabledEmitters[fnName] != null) {</span>
<span class="cstat-no" title="statement not covered" >      throw Error("" + fnName + " is already a disabled emitter");</span>
    }
<span class="cstat-no" title="statement not covered" >    this._disabledEmitters[fnName] = this[fnName];</span>
<span class="cstat-no" title="statement not covered" >    return this[fnName] = <span class="fstat-no" title="function not covered" >function() {</span>};</span>
  };
&nbsp;
  Emitter.prototype._enableEmitter = <span class="fstat-no" title="function not covered" >function(fnName) {</span>
<span class="cstat-no" title="statement not covered" >    var fn;</span>
<span class="cstat-no" title="statement not covered" >    fn = this._disabledEmitters[fnName];</span>
<span class="cstat-no" title="statement not covered" >    if (fn == null) {</span>
<span class="cstat-no" title="statement not covered" >      throw Error("" + fnName + " is not a disabled emitter");</span>
    }
<span class="cstat-no" title="statement not covered" >    this[fnName] = fn;</span>
<span class="cstat-no" title="statement not covered" >    return delete this._disabledEmitters[fnName];</span>
  };
&nbsp;
  return Emitter;
&nbsp;
