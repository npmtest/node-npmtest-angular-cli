...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular-cli/node_modules/angular-cli/node_modules/html-webpack-plugin/node_modules/pretty-error/node_modules/renderkid/node_modules/utila/scripts/js/lib/classic.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/html-webpack-plugin/node_modules/pretty-error/node_modules/renderkid/node_modules/utila/scripts/js/lib/classic.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/html-webpack-plugin/node_modules/pretty-error/node_modules/renderkid/node_modules/utila/scripts/js/lib/</a> &#187; classic.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var classic,
  __slice = [].slice;
&nbsp;
module.exports = classic = {};
&nbsp;
classic.implement = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var classProto, classReference, desc, member, mixin, mixins, _i, _j, _len;</span>
<span class="cstat-no" title="statement not covered" >  mixins = 2 &lt;= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), classReference = arguments[_i++];</span>
<span class="cstat-no" title="statement not covered" >  for (_j = 0, _len = mixins.length; _j &lt; _len; _j++) {</span>
<span class="cstat-no" title="statement not covered" >    mixin = mixins[_j];</span>
<span class="cstat-no" title="statement not covered" >    classProto = classReference.prototype;</span>
<span class="cstat-no" title="statement not covered" >    for (member in mixin.prototype) {</span>
<span class="cstat-no" title="statement not covered" >      if (!Object.getOwnPropertyDescriptor(classProto, member)) {</span>
<span class="cstat-no" title="statement not covered" >        desc = Object.getOwnPropertyDescriptor(mixin.prototype, member);</span>
<span class="cstat-no" title="statement not covered" >        Object.defineProperty(classProto, member, desc);</span>
      }
    }
  }
<span class="cstat-no" title="statement not covered" >  return classReference;</span>
};
&nbsp;
classic.mix = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var classProto, classReference, desc, member, mixin, mixins, _i, _j, _len;</span>
<span class="cstat-no" title="statement not covered" >  mixins = 2 &lt;= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), classReference = arguments[_i++];</span>
<span class="cstat-no" title="statement not covered" >  classProto = classReference.prototype;</span>
<span class="cstat-no" title="statement not covered" >  classReference.__mixinCloners = [];</span>
<span class="cstat-no" title="statement not covered" >  classReference.__applyClonersFor = <span class="fstat-no" title="function not covered" >function(instance, args) {</span></span>
<span class="cstat-no" title="statement not covered" >    var cloner, _j, _len, _ref;</span>
...
<span class="cstat-no" title="statement not covered" >    _ref = classReference.__mixinCloners;</span>
<span class="cstat-no" title="statement not covered" >    for (_j = 0, _len = _ref.length; _j &lt; _len; _j++) {</span>
<span class="cstat-no" title="statement not covered" >      cloner = _ref[_j];</span>
<span class="cstat-no" title="statement not covered" >      cloner.apply(instance, args);</span>
    }
  };
<span class="cstat-no" title="statement not covered" >  classReference.__mixinInitializers = [];</span>
<span class="cstat-no" title="statement not covered" >  classReference.__initMixinsFor = <span class="fstat-no" title="function not covered" >function(instance, args) {</span></span>
<span class="cstat-no" title="statement not covered" >    var initializer, _j, _len, _ref;</span>
<span class="cstat-no" title="statement not covered" >    if (args == null) {</span>
<span class="cstat-no" title="statement not covered" >      args = null;</span>
    }
<span class="cstat-no" title="statement not covered" >    _ref = classReference.__mixinInitializers;</span>
<span class="cstat-no" title="statement not covered" >    for (_j = 0, _len = _ref.length; _j &lt; _len; _j++) {</span>
<span class="cstat-no" title="statement not covered" >      initializer = _ref[_j];</span>
<span class="cstat-no" title="statement not covered" >      initializer.apply(instance, args);</span>
    }
  };
<span class="cstat-no" title="statement not covered" >  classReference.__mixinQuitters = [];</span>
<span class="cstat-no" title="statement not covered" >  classReference.__applyQuittersFor = <span class="fstat-no" title="function not covered" >function(instance, args) {</span></span>
<span class="cstat-no" title="statement not covered" >    var quitter, _j, _len, _ref;</span>
<span class="cstat-no" title="statement not covered" >    if (args == null) {</span>
<span class="cstat-no" title="statement not covered" >      args = null;</span>
    }
<span class="cstat-no" title="statement not covered" >    _ref = classReference.__mixinQuitters;</span>
<span class="cstat-no" title="statement not covered" >    for (_j = 0, _len = _ref.length; _j &lt; _len; _j++) {</span>
<span class="cstat-no" title="statement not covered" >      quitter = _ref[_j];</span>
<span class="cstat-no" title="statement not covered" >      quitter.apply(instance, args);</span>
    }
  };
<span class="cstat-no" title="statement not covered" >  for (_j = 0, _len = mixins.length; _j &lt; _len; _j++) {</span>
<span class="cstat-no" title="statement not covered" >    mixin = mixins[_j];</span>
<span class="cstat-no" title="statement not covered" >    if (!(mixin.constructor instanceof Function)) {</span>
<span class="cstat-no" title="statement not covered" >      throw Error("Mixin should be a function");</span>
    }
<span class="cstat-no" title="statement not covered" >    for (member in mixin.prototype) {</span>
<span class="cstat-no" title="statement not covered" >      if (member.substr(0, 11) === '__initMixin') {</span>
<span class="cstat-no" title="statement not covered" >        classReference.__mixinInitializers.push(mixin.prototype[member]);</span>
<span class="cstat-no" title="statement not covered" >        continue;</span>
      } else <span class="cstat-no" title="statement not covered" >if (member.substr(0, 11) === '__clonerFor') {</span>
<span class="cstat-no" title="statement not covered" >        classReference.__mixinCloners.push(mixin.prototype[member]);</span>
<span class="cstat-no" title="statement not covered" >        continue;</span>
      } else <span class="cstat-no" title="statement not covered" >if (member.substr(0, 12) === '__quitterFor') {</span>
<span class="cstat-no" title="statement not covered" >        classReference.__mixinQuitters.push(mixin.prototype[member]);</span>
<span class="cstat-no" title="statement not covered" >        continue;</span>
      }
<span class="cstat-no" title="statement not covered" >      if (!Object.getOwnPropertyDescriptor(classProto, member)) {</span>
<span class="cstat-no" title="statement not covered" >        desc = Object.getOwnPropertyDescriptor(mixin.prototype, member);</span>
