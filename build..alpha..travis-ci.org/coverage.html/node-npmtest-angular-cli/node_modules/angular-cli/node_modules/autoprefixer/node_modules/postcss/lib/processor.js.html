...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/processor.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/processor.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/</a> &#187; processor.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    var plugins = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Processor);</span>
&nbsp;
    /**
     ...
     * }
     */
<span class="cstat-no" title="statement not covered" >    this.version = '5.2.17';</span>
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.plugins = this.normalize(plugins);</span>
  }
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Processor.prototype.use = <span class="fstat-no" title="function not covered" >function use(plugin) {</span>
<span class="cstat-no" title="statement not covered" >    this.plugins = this.plugins.concat(this.normalize([plugin]));</span>
...
&nbsp;
&nbsp;
  Processor.prototype.process = <span class="fstat-no" title="function not covered" >function process(css) {</span>
<span class="cstat-no" title="statement not covered" >    var opts = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return new _lazyResult2.default(this, css, opts);</span>
  };
&nbsp;
  Processor.prototype.normalize = <span class="fstat-no" title="function not covered" >function normalize(plugins) {</span>
<span class="cstat-no" title="statement not covered" >    var normalized = [];</span>
<span class="cstat-no" title="statement not covered" >    for (var _iterator = plugins, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var i = _ref;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (i.postcss) <span class="cstat-no" title="statement not covered" >i = i.postcss;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if ((typeof i === 'undefined' ? 'undefined' : _typeof(i)) === 'object' &amp;&amp; Array.isArray(i.plugins)) {</span>
<span class="cstat-no" title="statement not covered" >        normalized = normalized.concat(i.plugins);</span>
      } else <span class="cstat-no" title="statement not covered" >if (typeof i === 'function') {</span>
<span class="cstat-no" title="statement not covered" >        normalized.push(i);</span>
      } else <span class="cstat-no" title="statement not covered" >if ((typeof i === 'undefined' ? 'undefined' : _typeof(i)) === 'object' &amp;&amp; (i.parse || i.stringify)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('PostCSS syntaxes cannot be used as plugins. ' + 'Instead, please use one of the ' + 'syntax/parser/stringifier options as ' + 'outlined in your PostCSS ' + 'runner documentation.');</span>
      } else {
<span class="cstat-no" title="statement not covered" >        throw new Error(i + ' is not a PostCSS plugin');</span>
      }
    }
