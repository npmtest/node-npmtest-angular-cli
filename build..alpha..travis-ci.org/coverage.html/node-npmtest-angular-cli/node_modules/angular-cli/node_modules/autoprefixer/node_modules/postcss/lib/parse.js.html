...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/parse.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/parse.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/</a> &#187; parse.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function parse(css, opts) {</span>
<span class="cstat-no" title="statement not covered" >    if (opts &amp;&amp; opts.safe) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Option safe was removed. ' + 'Use parser: require("postcss-safe-parser")');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var input = new _input2.default(css, opts);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var parser = new _parser2.default(input);</span>
...
<span class="cstat-no" title="statement not covered" >        if (e.name === 'CssSyntaxError' &amp;&amp; opts &amp;&amp; opts.from) {</span>
<span class="cstat-no" title="statement not covered" >            if (/\.scss$/i.test(opts.from)) {</span>
<span class="cstat-no" title="statement not covered" >                e.message += '\nYou tried to parse SCSS with ' + 'the standard CSS parser; ' + 'try again with the postcss-scss parser';</span>
            } else <span class="cstat-no" title="statement not covered" >if (/\.sass/i.test(opts.from)) {</span>
<span class="cstat-no" title="statement not covered" >                e.message += '\nYou tried to parse Sass with ' + 'the standard CSS parser; ' + 'try again with the postcss-sass parser';</span>
            } else <span class="cstat-no" title="statement not covered" >if (/\.less$/i.test(opts.from)) {</span>
<span class="cstat-no" title="statement not covered" >                e.message += '\nYou tried to parse Less with ' + 'the standard CSS parser; ' + 'try again with the postcss-less parser';</span>
            }
        }
