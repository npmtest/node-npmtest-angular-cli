...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/list.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/list.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/</a> &#187; list.js</div>
</div>
<div class="body">
 ...
 */
var list = {
    split: <span class="fstat-no" title="function not covered" >function split(string, separators, last) {</span>
...
<span class="cstat-no" title="statement not covered" >        var split = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var func = 0;</span>
<span class="cstat-no" title="statement not covered" >        var quote = false;</span>
<span class="cstat-no" title="statement not covered" >        var escape = false;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                    escape = false;</span>
                } else <span class="cstat-no" title="statement not covered" >if (letter === '\\') {</span>
<span class="cstat-no" title="statement not covered" >                    escape = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (letter === quote) {</span>
<span class="cstat-no" title="statement not covered" >                    quote = false;</span>
                }
            } else <span class="cstat-no" title="statement not covered" >if (letter === '"' || letter === '\'') {</span>
<span class="cstat-no" title="statement not covered" >                quote = letter;</span>
            } else <span class="cstat-no" title="statement not covered" >if (letter === '(') {</span>
<span class="cstat-no" title="statement not covered" >                func += 1;</span>
            } else <span class="cstat-no" title="statement not covered" >if (letter === ')') {</span>
<span class="cstat-no" title="statement not covered" >                if (func &gt; 0) <span class="cstat-no" title="statement not covered" >func -= 1;</span></span>
            } else <span class="cstat-no" title="statement not covered" >if (func === 0) {</span>
<span class="cstat-no" title="statement not covered" >                if (separators.indexOf(letter) !== -1) <span class="cstat-no" title="statement not covered" >split = true;</span></span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (split) {</span>
<span class="cstat-no" title="statement not covered" >                if (current !== '') <span class="cstat-no" title="statement not covered" >array.push(current.trim());</span></span>
...
<span class="cstat-no" title="statement not covered" >                current += letter;</span>
            }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (last || current !== '') <span class="cstat-no" title="statement not covered" >array.push(current.trim());</span></span>
...
&nbsp;
     ...
     */
    space: <span class="fstat-no" title="function not covered" >function space(string) {</span>
<span class="cstat-no" title="statement not covered" >        var spaces = [' ', '\n', '\t'];</span>
<span class="cstat-no" title="statement not covered" >        return list.split(string, spaces);</span>
    },
&nbsp;
&nbsp;
    /**
     ...
     */
    comma: <span class="fstat-no" title="function not covered" >function comma(string) {</span>
<span class="cstat-no" title="statement not covered" >        var comma = ',';</span>
<span class="cstat-no" title="statement not covered" >        return list.split(string, [comma], true);</span>
    }
};
&nbsp;
