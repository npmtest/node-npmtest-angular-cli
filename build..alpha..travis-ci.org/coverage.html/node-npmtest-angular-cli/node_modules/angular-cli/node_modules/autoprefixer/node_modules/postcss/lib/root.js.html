...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/root.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/root.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/autoprefixer/node_modules/postcss/lib/</a> &#187; root.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function Root(defaults) {</span>
<span class="cstat-no" title="statement not covered" >        _classCallCheck(this, Root);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _this.type = 'root';</span>
...
&nbsp;
    Root.prototype.removeChild = <span class="fstat-no" title="function not covered" >function removeChild(child) {</span>
<span class="cstat-no" title="statement not covered" >        child = this.index(child);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (child === 0 &amp;&amp; this.nodes.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >            this.nodes[1].raws.before = this.nodes[child].raws.before;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return _Container.prototype.removeChild.call(this, child);</span>
    };
&nbsp;
    Root.prototype.normalize = <span class="fstat-no" title="function not covered" >function normalize(child, sample, type) {</span>
<span class="cstat-no" title="statement not covered" >        var nodes = _Container.prototype.normalize.call(this, child);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (sample) {</span>
<span class="cstat-no" title="statement not covered" >            if (type === 'prepend') {</span>
<span class="cstat-no" title="statement not covered" >                if (this.nodes.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >                    sample.raws.before = this.nodes[1].raws.before;</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    delete sample.raws.before;</span>
                }
            } else <span class="cstat-no" title="statement not covered" >if (this.first !== sample) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                    node.raws.before = sample.raws.before;</span>
                }
            }
        }
&nbsp;
...
&nbsp;
&nbsp;
    Root.prototype.toResult = <span class="fstat-no" title="function not covered" >function toResult() {</span>
<span class="cstat-no" title="statement not covered" >        var opts = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var LazyResult = require('./lazy-result');</span>
<span class="cstat-no" title="statement not covered" >        var Processor = require('./processor');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var lazy = new LazyResult(new Processor(), this, opts);</span>
<span class="cstat-no" title="statement not covered" >        return lazy.stringify();</span>
    };
&nbsp;
    Root.prototype.remove = <span class="fstat-no" title="function not covered" >function remove(child) {</span>
<span class="cstat-no" title="statement not covered" >        (0, _warnOnce2.default)('Root#remove is deprecated. Use Root#removeChild');</span>
<span class="cstat-no" title="statement not covered" >        this.removeChild(child);</span>
    };
&nbsp;
    Root.prototype.prevMap = <span class="fstat-no" title="function not covered" >function prevMap() {</span>
<span class="cstat-no" title="statement not covered" >        (0, _warnOnce2.default)('Root#prevMap is deprecated. Use Root#source.input.map');</span>
<span class="cstat-no" title="statement not covered" >        return this.source.input.map;</span>
    };
&nbsp;
    /**
     * @memberof Root#
