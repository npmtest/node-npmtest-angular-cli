...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular-cli/node_modules/angular-cli/node_modules/common-tags/lib/trimResultTransformer/trimResultTransformer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/common-tags/lib/trimResultTransformer/trimResultTransformer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular-cli/node_modules/angular-cli/node_modules/common-tags/lib/trimResultTransformer/</a> &#187; trimResultTransformer.js</div>
</div>
<div class="body">
...
var trimResultTransformer = function trimResultTransformer() {
  var side = arguments.length &gt; 0 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >arguments[0] !== undefined </span>? <span class="branch-0 cbranch-no" title="branch not covered" >arguments[0] </span>: '';
  return {
    onEndResult: function onEndResult(endResult) {
      side = side.toLowerCase();
      // uppercase the first letter of side value
      <span class="missing-if-branch" title="if path not taken" >I</span>if (side === 'left' || side === 'right') {
<span class="cstat-no" title="statement not covered" >        side = side.charAt(0).toUpperCase() + side.slice(1);</span>
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (side !== '') {
<span class="cstat-no" title="statement not covered" >        throw new Error('Side not supported: ' + side);</span>
      }
